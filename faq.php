...
<div class="accordion" id="faqAccordion">
  <div class="card bg-dark text-light mb-2">
    <div class="card-header" id="faq1">
      <h5 class="mb-0"><button class="btn btn-link text-warning" type="button" data-toggle="collapse" data-target="#collapse1">How do I reserve a parking slot?</button></h5>
    </div>
    <div id="collapse1" class="collapse show" data-parent="#faqAccordion">
      <div class="card-body">Login, add your vehicle, go to Reserve, select a slot, set your time, and confirm your reservation.</div>
    </div>
  </div>
  <div class="card bg-dark text-light mb-2">
    <div class="card-header" id="faq2">
      <h5 class="mb-0"><button class="btn btn-link text-warning" type="button" data-toggle="collapse" data-target="#collapse2">Can I cancel or change my reservation?</button></h5>
    </div>
    <div id="collapse2" class="collapse" data-parent="#faqAccordion">
      <div class="card-body">Yes, you can cancel or modify your reservation from the My Bookings page before your reservation starts.</div>
    </div>
  </div>
  <div class="card bg-dark text-light mb-2">
    <div class="card-header" id="faq3">
      <h5 class="mb-0"><button class="btn btn-link text-warning" type="button" data-toggle="collapse" data-target="#collapse3">What payment methods are accepted?</button></h5>
    </div>
    <div id="collapse3" class="collapse" data-parent="#faqAccordion">
      <div class="card-body">Currently, you can pay with cash on arrival. Online payment options are coming soon.</div>
    </div>
  </div>
  <div class="card bg-dark text-light mb-2">
    <div class="card-header" id="faq4">
      <h5 class="mb-0"><button class="btn btn-link text-warning" type="button" data-toggle="collapse" data-target="#collapse4">How do I contact support?</button></h5>
    </div>
    <div id="collapse4" class="collapse" data-parent="#faqAccordion">
      <div class="card-body">Email us at <a href="mailto:support@easypark.com" class="text-warning">support@easypark.com</a> for assistance.</div>
    </div>
  </div>
</div>
