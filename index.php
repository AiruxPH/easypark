...
<head>
  ...
  <meta name="description"
    content="EasyPark - Reserve your parking spot anytime, anywhere. Real-time parking availability and smart parking solutions.">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="w-100 d-flex justify-content-center align-items-center container" style="height: 90vh">
            <div class="container p-5" style="height: 90%;">
              <br><br>
              <h1 class="custom-size display-4" style="text-align: center;">Welcome to EASYPARK</h1>
              <br>
        ...
        <div class="carousel-item">
          <div class="w-100 d-flex justify-content-center align-items-center container" style="height: 90vh">
            <div class="container p-5" style="height: 90%;">
              <br><br>
              <h1 class="custom-size display-4" style="text-align: center;">Park with Confidence</h1>
              <br>
        ...
        <div class="carousel-item">
          <div class="w-100 d-flex justify-content-center align-items-center container" style="height: 90vh">
            <div class="container p-5" style="height: 90%;">
              <br><br>
              <h1 class="custom-size display-4" style="text-align: center;">Save Time & Fuel</h1>
              <br>
