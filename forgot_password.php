  ...
  <div class="card bg-white shadow-lg p-4" style="max-width: 400px; background: rgba(255, 255, 255, 0.9) !important;">
    ...
    <form action="forgot_password.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="email" name="email" id="email" required placeholder="Email address" class="form-control" value="<?= htmlspecialchars($email) ?>" />
      </div>
      <div class="form-group">
        <label for="security_word" class="small font-weight-bold text-muted">
          Security Word <span class="text-danger">*</span>
        </label>
        <input type="text" name="security_word" id="security_word" required placeholder="Your security word" class="form-control" />
      </div>
    ...
    <form action="forgot_password.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="password" name="new_password" id="new_password" required placeholder="New password" class="form-control" />
      </div>
      <div class="form-group">
