        ...
        <tbody>
          <?php foreach ($vehicles as $vehicle): ?>
            <tr>
              ...
              <td>
                <?php if (isset($vehicle_active_reservations[$vehicle['vehicle_id']])):
                  ...
                  <button class="btn btn-sm btn-info" data-toggle="modal"
                    data-target="#reservationModal<?= $vehicle['vehicle_id'] ?>">
              ...
              <td>
                <?php if (!isset($vehicle_active_reservations[$vehicle['vehicle_id']])): ?>
                  <a href="vehicles.php?delete_vehicle=<?= $vehicle['vehicle_id'] ?>" class="btn btn-sm btn-danger"
            ...
            <?php if (isset($vehicle_active_reservations[$vehicle['vehicle_id']])):
              $res = $vehicle_active_reservations[$vehicle['vehicle_id']]; ?>
              <!-- Reservation Modal -->
              <div class="modal fade" id="reservationModal<?= $vehicle['vehicle_id'] ?>" tabindex="-1" role="dialog"
                aria-labelledby="reservationModalLabel<?= $vehicle['vehicle_id'] ?>" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="reservationModalLabel<?= $vehicle['vehicle_id'] ?>">Active Reservation
                        Details</h5>
