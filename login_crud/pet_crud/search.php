...
<html>
<head>
  <title>Search | Pets Organizer</title>
...
<body>
  ...
  <div class="container">
    <h2>Search Pet</h2>
    <form method="GET">
      <input type="text" name="query" class="form-control mb-3" placeholder="Enter name to search...">
    ...
    if (isset($_GET['query'])) {
        $q = $_GET['query'];
        $result = $conn->query("SELECT * FROM pets_rec WHERE name LIKE '%$q%'");
