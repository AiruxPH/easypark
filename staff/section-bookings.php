...
// Database connection (assuming $conn is defined in section-common.php)
// Ensure $conn is a valid PDO or mysqli connection

// Initialize variables for feedback messages
$success_message = '';
$error_message = '';

// Handle form submissions for confirm/cancel actions
...
try {
    $query = "
        SELECT 
            r.reservation_id, r.start_time, r.end_time, r.status,
            u.first_name, u.last_name,
            ps.slot_number, ps.slot_type,
            vm.brand, vm.model, v.plate_number,
            TIMESTAMPDIFF(HOUR, r.start_time, r.end_time) AS duration
        FROM reservations r
        JOIN users u ON r.user_id = u.user_id
        JOIN parking_slots ps ON r.parking_slot_id = ps.parking_slot_id
            ...
            <tbody>
                ...
                <?php else: foreach ($bookings as $b): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($b['duration']) ?> hours</td>
