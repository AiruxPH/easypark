...
<body>
      ...
      <div class="section-card mb-4 p-4">
        ...
        <div class="row align-items-center">
          <div class="col-md-4 text-center mb-3 mb-md-0">
            <img src="<?= htmlspecialchars($profilePic) ?>" alt="Profile Picture" class="rounded-circle mb-2 shadow"
            ...
            <form method="POST" enctype="multipart/form-data" class="mt-2">
              <div class="custom-file mb-1 position-relative">
                <input type="file" name="profile_pic" accept="image/*" class="custom-file-input form-control d-none"
                  id="profilePicInput">
                <label class="custom-file-label btn btn-outline-warning w-100" for="profilePicInput"
                  id="profilePicLabel">
  ...
  <div id="resetPasswordOverlay"
    style="display:none;position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(30,30,30,0.92);z-index:9999;align-items:center;justify-content:center;">
    <div class="profile-container" style="max-width:400px;margin:auto;position:relative;">
      <button type="button" class="btn-close position-absolute end-0 top-0 m-2" aria-label="Close"
        onclick="hideResetOverlay()" style="background:none;border:none;font-size:2rem;color:#fff;">&times;</button>
  ...
  <script>
    ...
    $(function () {
      $('#resetPasswordForm').on('submit', function (e) {
        ...
        $.post('reset_password_ajax.php', { email: email, security_word: security, new_password: newpass }, function (data) {
          msgBox.html(data);
        }).fail(function () {
